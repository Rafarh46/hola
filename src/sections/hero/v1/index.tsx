          ...
          {items.map((item, index) => (
            <SwiperSlide key={index}>
              ...
              >
                ...
                <div
                  className={cn(
                    'absolute inset-0 -z-1 bg-accent-700 bg-cover bg-no-repeat [background-position:top_center] [transform:scale(1)] [transition:7000ms_ease,opacity_500ms_ease-in]',
                    styles['hero-bg'],
                    // before
